...
!(function (a, n) {
    ...
    var m = !0,
      ...
      a = function () {
        l = s;
        for (
          var a = document.getElementsByClassName("crs-country"), n = 0;
          n < a.length;
          n++
        )
          e(a[n]);
      ...
      e = function (a) {
        if ("true" !== a.getAttribute("data-crs-loaded")) {
          ...
          for (var s = 0; s < t.length; s++) {
            ...
            t[s][4] && (u = ""),
              (a.options[a.length] = new Option(t[s][0], u)),
              null != r && r === u && ((l = s), m && l++);
          }
          a.selectedIndex = l;
          ...
          if (d) {
            ...
            if (h)
              ...
              console.error(
                "Region dropdown DOM node with ID " + d + " not found."
              );
      ...
      M = function (a) {
        ...
        (h = null === i || "true" === i),
          (a.length = 0),
          h && ((a.options[0] = new Option(e, "")), (a.selectedIndex = 0));
      },
      B = function () {
        for (var a = 0; a < l.length; a++) {
          for (
            var n = { hasShortcodes: /~/.test(l[a][2]), regions: [] },
              e = l[a][2].split("|"),
              i = 0;
            i < e.length;
            i++
      ...
      k = function (a, n, e, i) {
        for (var r = 0; r < n.regions.length; r++) {
          if (
            (i && n.hasShortcodes && n.regions[r][1]
              ? n.regions[r][1]
              : n.regions[r][0]) === e
          ) {
              ...
              if (!t.hasOwnProperty(n))
                if (((t[n] = []), a.whitelist)) {
                  ...
                  for (e = 0; e < s.length; e++)
                    -1 !== i.indexOf(s[e][1]) && t[n].push(e);
                } else if (a.blacklist) {
                  var r = a.blacklist.split(",");
                  for (e = 0; e < s.length; e++)
                    -1 === r.indexOf(s[e][1]) && t[n].push(e);
                }
              var o = [];
    ...
    return (
      (function (n, e) {
        var i = !1,
          ...
          u = function (a) {
            ("readystatechange" == a.type && "complete" != r.readyState) ||
              (("load" == a.type ? n : r)[t](s + a.type, u, !1),
              !i && (i = !0) && e.call(n, a.type || a));
          },
          d = function () {
            try {
              o.doScroll("left");
        ...
        if ("complete" == r.readyState) e.call(n, "lazy");
          ...
          r[l](s + "DOMContentLoaded", u, !1),
            r[l](s + "readystatechange", u, !1),
            n[l](s + "load", u, !1);
        }
      })(window, a),
      { init: a }
